...
const newUpdateRecord = (val) => {
    let activeWord, queryStr, queryTable;
        ...
        inquirer
            ...
            .then(function (answer) {
                ...
                if (answer.employeeUpdate) {
                    ...
                    queryParams = [updateThis, { id: parseInt(answer.choice) }]
                } else {
                    // if nothing to update, then simply pass id for query to use in DELETE mode
                    queryParams = { id: parseInt(answer.choice) }
                }
                ...
                connection.query(queryStr, queryParams, function (err, res) {
                    ...
                    if (answer.choice !== `<< Start Over`) {
                        console.log(`${miniSeparator}\t${res.affectedRows} record(s) ${activeWord.toUpperCase()}D!   ${miniSeparator}`)
                    }
